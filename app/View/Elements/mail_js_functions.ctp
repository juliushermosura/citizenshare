    ...
    $(document).ready(function() {
        ...
        function markasread(e) {
            if ($('#'+e).has('.subjectUnread')) {
                $.ajax({
                    url: '/dashboard/messages/mark_as_read/' + e.replace('mail-', ''),
                    type: 'GET'
                }).done(function() {
        ...
        function markasunread(e) {
            $.ajax({
                url: '/dashboard/messages/mark_as_unread/' + e.replace('mail-', ''),
                type: 'GET'
            }).done(function() {
        ...
        function deletemail(e) {
            $.ajax({
                url: '/dashboard/messages/delete_mail/' + e.replace('mail-', ''),
                type: 'GET'
            }).done(function() {
                $('#'+e).remove();
        ...
        $('#to').tokenInput('/dashboard/messages/retrieve_friends/', {
            theme: 'facebook',
