        ...
        <div class="messageslist">
            ...
            <div class="user_mail_details" id="mail-<?php echo $message['Inbox']['id'] ?>">
                ...
                <div class="user_mail_info">
                    <div class="user_brief_details"><?php echo String::truncate(!empty($message['Sender']['full_name']) ? $message['Sender']['full_name'] : htmlentities($message['Inbox']['sender_email'])) ?></div>
