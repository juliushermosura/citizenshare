        ...
        <div class="messageslist">
            ...
            <div class="user_mail_details" id="mail-<?php echo $message['Draft']['id'] ?>">
                ...
                <div class="user_mail_info">
                    <div class="user_brief_details"><?php echo $this->Html->link(String::truncate(!empty($message['Recipient']['full_name']) ? $message['Recipient']['full_name'] : htmlentities($message['Draft']['recipient_email']), 38, array('ellipsis' => '...')), array('controller' => 'messages', 'action' => 'view', !empty($message['Recipient']['username']) ? $message['Recipient']['username'] : !empty($message['Recipient']['id']) ? $message['Recipient']['id'] : $message['Draft']['recipient_email']), array('escape' => false, 'title' => !empty($message['Recipient']['full_name']) ? $message['Recipient']['full_name'] : htmlentities($message['Draft']['recipient_email']))) ?></div>
