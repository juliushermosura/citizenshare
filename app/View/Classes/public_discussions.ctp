<div class="contentarea">
  ...
  <div class="" id="public_discussions">
    ...
    <div class="class_view_left">
      <?php echo $this->element('sidebar_left_discussions', array('active' => 'public_discussions', 'id' => $class['OnlineClass']['id'])) ?>
    </div>
    
    <div class="class_view_middle expand marginleft250">
